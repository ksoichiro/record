...
func TestRecordCreateSuccessfully(t *testing.T) {
	...
	db.Create(&models.Task{ID: 201, UserID: 101, Title: "task2", Description: "task description", Type: 0, Amount: 0, CreatedAt: time.Now()})
	db.Create(&models.Task{ID: 202, UserID: 100, Title: "task3", Description: "task description", Type: 0, Amount: 0, CreatedAt: time.Now()})
...
func TestRecordList(t *testing.T) {
	...
	db.Create(&models.Task{ID: 201, UserID: 101, Title: "task2", Description: "task description", Type: 0, Amount: 0, CreatedAt: time.Now()})
	db.Create(&models.Task{ID: 202, UserID: 100, Title: "task3", Description: "task description", Type: 0, Amount: 0, CreatedAt: time.Now()})
	db.Create(&models.Record{ID: 300, UserID: 100, TargetDate: mustParse("2006-01-02", "2019-11-19"), TaskID: 200, Done: false, CreatedAt: time.Now()})
	db.Create(&models.Record{ID: 301, UserID: 100, TargetDate: mustParse("2006-01-02", "2019-11-20"), TaskID: 200, Done: false, CreatedAt: time.Now()})
	db.Create(&models.Record{ID: 302, UserID: 101, TargetDate: mustParse("2006-01-02", "2019-11-20"), TaskID: 201, Done: false, CreatedAt: time.Now()})
	db.Create(&models.Record{ID: 303, UserID: 100, TargetDate: mustParse("2006-01-02", "2019-11-21"), TaskID: 200, Done: false, CreatedAt: time.Now()})
	db.Create(&models.Record{ID: 304, UserID: 100, TargetDate: mustParse("2006-01-02", "2019-11-20"), TaskID: 202, Done: false, CreatedAt: time.Now()})
	router.Use(func(c *gin.Context) {
		c.Set("user", 100)
	})
